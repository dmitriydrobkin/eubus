    ...
    >
      <div className="w-full max-w-container-max mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="#schedule" className="text-ivory-text font-body hover:text-primary transition-colors duration-300">Розклад</Link>
          <Link href="#services" className="text-ivory-text font-body hover:text-primary transition-colors duration-300">Послуги</Link>
          <Link href="#vip" className="text-ivory-text font-body hover:text-primary transition-colors duration-300">VIP Трансфер</Link>
          <Link href="#contacts" className="text-ivory-text font-body hover:text-primary transition-colors duration-300">Контакти</Link>
        </div>
        {/* Trailing Action */}
